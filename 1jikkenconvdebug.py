...
toba_option = {"rmw_type":"coco_toba","epsilon":[0.7,0.7,0.7],"complement":True,"rmw_layer":["Affine1","Affine2","Affine3"],"delete_n":[10,10,10],"strict":True}
...
test = Trainer(network, step=[10,"toba"], optimizer=opt2, data=data, check=5, tobaoption=toba_option, scheduler=exp)
test.fit()
