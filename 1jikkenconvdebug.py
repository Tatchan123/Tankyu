...
exp = {"method":"exp", "base":0.8}


network = Convnetwork(input_size=(list(x_train[0].shape)), output_size=10, dense_layer=layer1, conv_layer=conv_layer1, weightinit=He, activation=Relu, batchnorm=True, drop_rate=[0.2,0.4], regularize=["l2",0.0002])
