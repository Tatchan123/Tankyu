...
toba_option = {"rmw_type":"coco_toba","epsilon":[0.0,0.0,0.0],"complement":True,"rmw_layer":["Affine1","Affine2","Affine3"],"delete_n":[156,78,39],"strict":False}
...
test = Trainer(network, step=[10,"toba",5], optimizer=opt2, data=data, check=5, tobaoption=toba_option, scheduler=exp)
test.fit()
