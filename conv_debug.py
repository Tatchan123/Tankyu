...
network = Convnetwork(input_size=(list(x_train[0].shape)), output_size=10, dense_layer=layer1, conv_layer=conv_layer1, weightinit=He, activation=[LeakyRelu,0.0], batchnorm=True, toba=True, drop_rate=[0.26,0.33], regularize=["l2",0.0005])
